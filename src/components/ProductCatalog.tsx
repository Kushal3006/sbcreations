...
const ProductCatalog: React.FC = () => {
  ...
  const categoryTitles: { [key: string]: string } = {
    ...
    'cards': 'Greeting Cards & Hampers',
    'phone-cases': 'Phone Cases',
    'wallClocks': 'Wall Clocks',
    'gift-idea': 'Gift Ideas'
  };

  const categoryName = category ? (categoryTitles[category] || category.replace('-', ' ')) : 'All Products';
      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-12">
          <div className="text-center md:text-left mb-6 md:mb-0">
            ...
            <p className="text-[#6B5B45] max-w-2xl mx-auto md:mx-0">
              {category 
                ? `Explore our collection of handcrafted ${categoryName.toLowerCase()}` 
